...
const methodSeed = [
  {
    ...
    preparation : [
      ...
      {
        step3 : "Place the cup/vessel onto scale"
      },
      {
        step4 : "Take the filter part out of the vessel"
      },
      {
        step5 : "Add the coffee into the vessel"
      },
      {
        step6 : "Turn on the scale, ensuring it reads 0g"
      },
      {
        step7 : "You’re all set!"
      }
    ],
    instructions : [
      {
        step1 : "Pour 60g of water and evenly saturate the coffee"
      },
      {
        step2 : "Gently stir the grounds to ensure all coffee is immersed"
      },
      {
        step3 : "Wait 30 seconds for coffee to bloom"
      },
      {
        step4 : "Pour the remaining 290g of water in a spiral motion"
      },
      {
        step5 : "Allow the coffee to steep for 3 minutes"
      },
      {
        step6 : "Gently press the filter down and serve in a warm cup"
      }
    ],
    difficulty : "Easy",
    information : "A French Press also know as a cafetiere, cafetiere a piston, Cafeteria, press pot, coffee press, or coffee plunger, is a coffee brewing device patented by Italian designer Attilio Calimani in 1929"
  },
  {
    method : "AeroPress",
    grind_size : "Fine",
    ...
    preparation : [
      ...
      {
        step3 : "Place paper filter into AeroPress cap"
      },
      {
        step4 : "Screw the AeroPress cap to the AeroPress chamber"
      },
      {
        step5 : "Place the cup/vessel onto scale"
      },
      {
        step6 : "Place your AeroPress onto the cup"
      },
      {
      ...
      {
        step9 : "Add the coffee into the AeroPress chamber"
      },
      {
    ...
    instructions : [
      {
        step1 : "Pour 30g of water and evenly saturate the coffee"
      },
      {
      ...
      {
        step4 : "Pour 210g of water in a spiral motion over the dark areas"
      },
      {
        step5 : "Place the plunger on the brewer and pul up slightly to create a pressure seal"
      },
      {
        step6 : "Wait for 30 seconds for the coffee to brew"
      },
      {
        step7 : "Gently press down on the plunger with steady pressure"
      },
      {
        step8 : "When done simply take off the bottom cap, pop the grounds and the filter"
      }
    ],
    difficulty : "Medium",
    information : "The AeroPress is the first coffee maker that combines affordability and simplicity with the ability to produce top quality coffee"
  },
  {
    method : "Moka Pot",
